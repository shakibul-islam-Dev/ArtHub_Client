  ...
  useEffect(() => {
    if (initialData) {
      ...
      reset({
        ...
        password: "",
        confirmPassword: "",
        externalImageUrl: actualUser?.image_url || actualUser?.image || "", // 👈 লাইন ৩৬: গুগল ইমেজ থাকলে সেটা এখানে সেট হবে
      });
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      let finalImageUrl =
        ...
        actualUser?.image ||
        ""; // 👈 লাইন ১১১: গুগল ইমেজ ব্যাকআপ ফলব্যাক
      ...
      if (res.ok && responseData.success) {
        ...
        // নতুন ডাটা দিয়ে ইন্টারনাল হুক ফর্ম স্টেট সিঙ্ক করা
        reset({
          name: payload.name,
          email: payload.email,
          phone: payload.phone,
