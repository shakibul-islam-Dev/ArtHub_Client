...
const ArtworkPagination = () => {
  ...
  const processedArtworks = filteredAndSortedArtworks.slice(
    indexOfFirstItem,
    indexOfLastItem,
  );
            ...
            {totalPages > 1 && (
              <div className="flex items-center justify-center space-x-2 pt-6">
                <button
                  ...
                  className="px-4 py-2 text-sm font-medium bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-xl disabled:opacity-50 disabled:cursor-not-allowed hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors"
                >
                  Previous
                </button>
                    ...
                    <button
                      ...
                      className={`w-10 h-10 text-sm font-bold rounded-xl transition-all ${
                        currentPage === pageNumber
                          ? "bg-neutral-900 text-white dark:bg-neutral-50 dark:text-neutral-950 shadow-md"
                          : "bg-white text-neutral-800 dark:bg-neutral-900 dark:text-neutral-200 border border-neutral-200 dark:border-neutral-800 hover:bg-neutral-100 dark:hover:bg-neutral-800"
                      }`}
                    >
                      {pageNumber}
                    </button>
